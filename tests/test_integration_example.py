...
async def test_canvas_operations_integration():
    ...
    async with TestClient(get_test_config()) as test_client:
        ...
        image = await client.create_image(canvas_id, image_path, {
            "title": "Test Image",
...
async def test_file_upload_integration():
    ...
    async with TestClient(get_test_config()) as test_client:
        ...
        video = await client.create_video(canvas_id, video_path, {
        ...
        pdf = await client.create_pdf(canvas_id, pdf_path, {
