...
- [🔄] **Task 4.1.1**: Implement widget creation method - Status: In Progress (Issue #7)
...
- [ ] **Task 5.1.2**: Implement set canvas background method
...
- [ ] **Task 5.1.3**: Implement set canvas background image method
...
- [ ] **Task 7.1.1**: Implement list groups method
  - **Endpoint**: `GET /groups`
...
- [ ] **Task 7.1.2**: Implement get group method
...
- [ ] **Task 7.1.3**: Implement create group method
...
- [ ] **Task 8.1.1**: Implement get client method
...
- [ ] **Task 9.1.1**: Implement list canvas video inputs method
...
- [ ] **Task 11.1.1**: Implement get audit log method
...
- [ ] **Task 11.1.2**: Implement export audit log CSV method
...
- [ ] **Task 12.1.1**: Implement get mipmap info method
...
- [ ] **Task 12.2.1**: Implement get asset file method
...
- [ ] **Task 13.1.1**: Implement list widget annotations method
...
- [ ] **Task 13.1.2**: Implement subscribe to annotations method
...
### 14.1 SAML Login
- [ ] **Task 14.1.1**: Implement SAML login method
...
- [ ] **Task 15.1.1**: Add missing model classes to `canvus_api/models.py`
  - **Models to add**:
...
- [ ] **Task 16.2.1**: Update API documentation
  - **Implementation Steps**:
